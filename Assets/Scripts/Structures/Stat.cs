...
public class Stat
{
    public List<float> summingMultiplers = new List<float>(new float[1]
        {
            1
        }),
    ...
    {
        return
            $"Value = {Value}, Base Value = {baseValue}, Sum of multiplers = {summingMultiplers.Sum()}, Sum of additions = {additions.Sum()}";
    }
}