...
namespace DustyStudios
{
    public class DustyConsoleWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            EditorGUI.TextArea(new Rect(0,otherElementsYsize,position.width,position.height - otherElementsYsize),DustyConsole.Output);
            DustyConsole.numberOfOutputInScreen = (int)((position.size.y - otherElementsYsize) / EditorGUIUtility.singleLineHeight);
        }
    }
}
    #endif